...
class PageController extends Controller
{
    ...
    function index(Request $request) {
        return view('rioHome.pages.index', ['categories' => Category::all(), 'products' => Product::all(), 'items' => Cart::where('user_ip', $request->ip())->get(), 'total' => 0]);
    }
    ...
    function checkout(Request $request) {
        return view('rioHome.pages.checkout', ['categories' => Category::all(), 'products' => Product::all(), 'items' => Cart::where('user_ip', $request->ip())->get(), 'total' => 0]);
    }
    ...
    function success(Request $request, User $user, $id) {
        ...
        if ($this->order) {
            ...
            return view('rioHome.pages.success', ['categories' => Category::all(), 'products' => Product::all(), 'items' => Cart::where('user_ip', $request->ip())->get(), 'total' => 0, 'order_id' => $id]);
        }
        else {
