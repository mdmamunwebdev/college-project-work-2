            ...
            <div class="col-md-4">
                <form action="{{ route('coupon.create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card card-body neumo-primary mb-2 p-0 ">
                        <input type="text" class="form-control" name="name" placeholder="Title : New Coupon"/>
                    </div>
                    <div class="card card-body neumo-primary mb-2 p-0">
                    ...
                    <div class="row g-2 mt-2">
                        <div class="col-md-6">
                            <div class="card card-body neumo-primary mb-2 p-0 ">
                                <input type="text" class="form-control" name="code" placeholder="Code: Ex, #*555fffr/*"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card card-body neumo-primary mb-2 p-0 ">
                                <input type="text" class="form-control" name="price" placeholder="Discount Price"/>
                            </div>
                        </div>
                    </div>
                    <div class="row g-2">
                        <div class="col-md-6">
                            <div class="card card-body neumo-primary mb-2 p-0 border-neumo">
                                <select name="calculation" id="" class="form-select bg-neumo text-primary-size">
                                    <option value="1" selected class="bg-neumo">Percentage</option>
                                    <option value="0" class="bg-neumo">Subtraction</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card card-body neumo-primary mb-2 p-0 border-neumo">
                                <select name="status" id="" class="form-select bg-neumo text-primary-size">
                                    ...
                                    <option value="0" class="bg-neumo">deactivate</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="example"
                        ...
                        @foreach ($coupons as $coupon)
                            <tr>
                                ...
                                <td>{{ $coupon->name }}</td>
                                <td style="text-transform: lowercase !important; ">{{ $coupon->code }}</td>
                                <td>
