...
@section('main-content')
    ...
    <div class="pagetitle neumo-primary p-3 d-flex justify-content-between">
        <h1 class="lh-base">Product Update</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('product.update', ['id' => $product->id]) }}">Product Update</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card card-body neumo-primary p-0">
                                <input type="text" class="form-control" name="name" placeholder="Title : New Product" value="{{ $product->name }}"/>
                            </div>
                        </div>
                        ...
                        <!-- Product Additional Data Tab Start -->
                        <div class="col-12">
                                                ...
                                                <div class="card bg-neumo-pills m-0 h-100">
                                                    <div class="card-body  p-3">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-4">
                                                                <input type="number" name="regular_price" id="" class="form-control" value="{{ $product->regular_price }}"/>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-12">
                                                                        <input type="date" name="start_sale_price_date"
                                                                               ...
                                                                               class="form-control"
                                                                               placeholder="From… YYYY-MM-DD" value="{{ $product->start_sale_price_date }}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <div class="col-12">
                                                                        <input type="date" name="end_sale_price_date"
                                                                               id="endSalePriceDate"
                                                                               class="form-control"
                                                                               placeholder="To… YYYY-MM-DD" value="{{ $product->end_sale_price_date }}"/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="radio-container">
                                                                    <div class="radio-wrapper">
                                                                        <label class="radio-button">
                                                                            <input type="radio" name="stock_status"
                                                                                   value="0" id="option1" {{ $product->stock_status == 0 ? 'checked' : '' }}/>
                                                                    ...
                                                                    <div class="radio-wrapper">
                                                                        <label class="radio-button">
                                                                            <input type="radio" name="stock_status"
                                                                                   value="1" id="option2" {{ $product->stock_status == 1 ? 'checked' : '' }}/>
                                                                            <span class="radio-checkmark"></span>
                                                                    ...
                                                                    <div class="radio-wrapper">
                                                                        <label class="radio-button">
                                                                            <input type="radio" name="stock_status"
                                                                                   value="2" id="option3" {{ $product->stock_status == 2 ? 'checked' : '' }}/>
                                                                            <span class="radio-checkmark"></span>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-6">
                                                                <input type="number" name="weight" id=""
                                                                       class="form-control" placeholder="0" value="{{ $product->weight }}">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-6">
                                                                <select name="condition" id=""
                                                                    ...
                                                                    <option value="0"  {{ $product->condition == 0 ? 'selected' : '' }} class="bg-neumo">New
                                                                    </option>
                                                                    <option value="1" {{ $product->condition == 1 ? 'selected' : '' }} class="bg-neumo">Refurbished
                                                                    </option>
                                                                    <option value="2" {{ $product->condition == 2 ? 'selected' : '' }} class="bg-neumo">Used</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <!-- Product Additional Data Tab End -->
                    </div>
                </div>
                <div class="col-md-4">
                    <!-- Product Update Tab Start -->
                                ...
                                <div class="accordion-body bg-neumo">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <button type="submit" id="productStatusBtn"
                                                        class="btn btn-sm neumo-primary border-secondary-neumo text-secondary-neumo text-primary-size {{ $product->status == 0 ? 'd-none' : 'd-block' }}">
                                                        {{ $product->status == 1 ? 'Pending Review' : 'Draft' }}
                                                </button>
                                            </div>
                                            <div>
                                                <button type="submit" id="productPreview"
                                    ...
                                    <div class="d-flex justify-content-between my-2 text-neumo">
                                        ...
                                        @elseif( $product->status == 1 )
                                            <span id="statusInfo">Pending Review</span>
                                        @else
                                            <span id="statusInfo">Draft</span>
                                        @endif
                                        <input id="product-status" type="text" hidden name="status" value="{{ $product->status }}"/>
                                        <div class="btn-group">
                                    ...
                                    <div class="d-flex justify-content-between mb-2 text-neumo">
                                        ...
                                        @elseif( $product->visibility == 1 )
                                            <span id="visibilityInfo">Private</span>
                                        @else
                                            <span id="visibilityInfo">Only for users</span>
                                        @endif
                                        <input id="product-visibility" type="text" hidden name="visibility" value="{{ $product->visibility }}"/>
                                        <div class="btn-group">
                                            <button class="btn btn-danger btn-sm" type="button">
                                                Edit
                                            </button>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <button type="submit" id="productPublished"
                                            class="btn btn-sm neumo-primary text-secondary-neumo border-secondary-neumo text-primary-size {{ $product->status == 0 ? 'd-block' : 'd-none' }}">
                                        Update
                                    </button>
                                </div>
                            </div>
                                        ...
                                        <div class="p-3 tab-pane fade show active bg-neumo text-neumo"
                                            ...
                                            @if( count($categories) )
                                                ...
                                                @foreach( $categories as $category )
                                                    ...
                                                    @if( count($productCat) )
                                                        ...
                                                        @foreach($productCat as $cat)
                                                            ...
                                                            @if($cat->category_id == $category->id)
                                                                ...
                                                                <label for="cat_{{ $category->id }}" class="me-1 mt-1">
                                                                    <input type="checkbox" checked  name="category[]" id="cat_{{ $category->id }}" value="{{ $category->id }}" class="me-2"/>
                                                                    {{ $category->name }}
                                                                </label>
                                                    ...
                                                    <label for="cat_{{ $category->id }}" class="me-1 mt-1">
                                                        <input type="checkbox"  name="category[]" id="cat_{{ $category->id }}" value="{{ $category->id }}" class="me-2"/>
                                                        {{ $category->name }}
                                                    </label>
                    ...
                    <!-- Product Image Upload Tab Start -->
    ...
    <script type="text/javascript">
        ...
        function productStatus(status) {
            ...
            if (status === 0) {
                ...
                productStatusBtn.setAttribute('style', 'display:block !important');
                productStatusBtn.innerHTML = 'Draft';
